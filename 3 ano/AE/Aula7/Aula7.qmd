...
P <- matrix(c(1, r, r, 1), nrow = 2, byrow = TRUE)
...
3.  Compare com (A) e comente o efeito de $X_3$ ser **não correlacionada** com $X_1$ e $X_2$.
    ...
    # 1.
      ...
      res$values    # autovalores  -> variância de cada CP
    res$vectors   # autovetores ->        coeficientes das CPs

    # 2.
    autovalores <- res$values
    total_var   <- sum(autovalores)
    prop_var    <- autovalores / total_var
